...
def checkout(skus: str) -> int:
    ...
    offer_registry = offer.OfferRegistry(
        ...
        offer.CrossBuyOffer(product_code="E", price=offer.Price(1, 40), free_product_code="B", trigger_quantity=2),
        offer.FreeBuyOffer(product_code="F", price=offer.Price(1, 10), trigger_quantity=2),
        ...
        offer.CrossBuyOffer(product_code="N", price=offer.Price(1, 40), free_product_code="M", trigger_quantity=3),
        ...
        offer.CrossBuyOffer(product_code="R", price=offer.Price(1, 50), free_product_code="Q", trigger_quantity=3),
        offer.MultiBuyOffer(product_code="S", prices=[offer.Price(1, 30)]),
        offer.MultiBuyOffer(product_code="T", prices=[offer.Price(1, 20)]),
        offer.FreeBuyOffer(product_code="U", price=offer.Price(1, 40), trigger_quantity=3),
